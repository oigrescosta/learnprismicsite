...
export interface BentoSliceDefaultPrimary {
	...
	/**
	 * Bento Box field in *Bento → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.primary.bento_box[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	bento_box: prismic.GroupField<Simplify<BentoDocumentDataBentoBoxItem>>;
}
...
export interface CaseStudiesSliceDefaultPrimary {
	...
	/**
	 * Case Studies Box field in *CaseStudies → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: case_studies.primary.case_studies_box[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	case_studies_box: prismic.GroupField<Simplify<CaseStudiesDocumentDataCaseStudiesBoxItem>>;
}
...
export interface IntegrationsSliceDefaultPrimary {
	...
	/**
	 * Integrations Box field in *Integrations → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: integrations.primary.integrations_box[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	integrations_box: prismic.GroupField<Simplify<IntegrationsDocumentDataIntegrationsBoxItem>>;
}
...
declare module '@prismicio/client' {
	...
	namespace Content {
		export type {
			...
			CaseStudiesSlice,
			CaseStudiesDocumentDataCaseStudiesBoxItem,
			...
			HeroSliceDefault,
			IntegrationsSlice,
			IntegrationsDocumentDataIntegrationsBoxItem,
