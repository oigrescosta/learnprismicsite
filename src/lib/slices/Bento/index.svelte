<script>
	...
	import { PrismicText, PrismicRichText, PrismicImage } from "@prismicio/svelte";
...
<Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>
	...
	<div class="mt-16 grid max-w-4xl grid-rows-[auto_auto_auto] gap-8 md:grid-cols-3 md:gap-10">
		{#each slice.primary.bento_box as item}
			<div
				class={clsx("glass-container row-span-3 grid grid-rows-subgrid gap-4 rounded-lg bg-gray-950/60 p-4 before:bg-gray-100/10", item.wide ? 'md:col-span-2' : 'md:col-span-1')}>
