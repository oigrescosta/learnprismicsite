...
<Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation} class="relative">
	<div class="showcase__glow rounded-full absolute -z-10 aspect-video w-full max-w-2xl bg-violet-500 min-blend-screen blur-[120px] filter" />
	...
	<div class="relative mt-16 grid items-center gap-8 rounded-xl border border-violet-50/20 bg-gradient-to-b from-gray-50/15 to-gray-50/5 px-8 py-8 backdrop-blue-sm lg:grid-cols-3 lg:gap-0 lg:py-12">

		<div class="grid-background" />

		<div>
			{#if slice.primary.icon}
				<div class="rounded-lg w-fit bg-violet-800 p-4 text-3xl">
